...
import { faSlidersH, faChevronDown, faThumbtack, faInfinity } from '@fortawesome/free-solid-svg-icons';
        ...
        <ProductFormContainer style={{ marginBottom: "20px" }} className="RowHeadClass">
            <Row className="RowFlex">
                ...
                <Col style={{ position: "relative" }} className="col-2">
                    ...
                    <span className="spanPlusClass" onClick={handleModalShow}>+</span>
                </Col>
                <Col className="col-3" style={{ marginTop: "10px" }}>
                    <div className="product-info">
                        <div style={{ display: "flex" }}>
                            <div className="product-name" style={{ width: "50%" }}>
                                <input type="text" className="product-name-input" value="Netflix" style={{ width: "90%" }} />
                            </div>
                            <div className="product-name-input" style={{ display: "flex", width: "50%", height: "45px", marginTop: "10px" }} >
                                <div>
                                    <input
                                        type="number"
                                        name="price"
                                ...
                                <div className="labelPriceClass" style={{ borderRight: "1px solid #aaa", padding: "2px" }}>
                                    <label>ر.س</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="product-options">
                            <div style={{ display: "flex" }}>
                                <div className="product-name" style={{ width: "50%" }}>
                                    <input type="text" className="product-name-input" value="كمية غير محدودة" style={{ width: "90%" }} disabled />
                                </div>
                                <div className="tab-container" style={{ height: "48px", marginTop: "10px" }}>
                                    <select className="tab-item"  placeholder="اختر تصنيف المنتج" style={{ border: "none", marginRight: "-5px" }}>
                                    ...
                                    <span className="tab-item" onClick={handleCategoryModalShow}>اضف تصنيف</span>
                                </div>
                            </div>
                        </div>
                    </div>
