            ...
            >
                ...
                >
                    <div style={{ textAlign: "center" }}>
                        ...
                        >
                            <h4> <i className="sicon-filter mx-2" style={{ fontSize: "15px" }}></i>فرز العملاء حسب</h4>
                        ...
                        <div>
                            ...
                            <div className="search-container">
                                <input type="text" className="search-input" placeholder="ابحث عن ما تريد" style={{marginBottom:"20px"}} />
                                <i className="sicon-user search-icon" ></i>
                            </div>
                        </div>
                        <Accordion defaultActiveKey="0" className="custom-accordion">
                            ...
                            <Accordion.Item eventKey="1" style={{ border: "none" }}>
                                ...
                                <Accordion.Body>
                                    <label style={{ position: "absolute", right: "80px"}}>الدولة</label>
                                    <Form.Select
                                        aria-label="الدولة"
                                    ...
                                    <label style={{ position: "absolute", right: "80px",marginTop:"10px" }}>المدينة</label>
                                    <Form.Select
                                        aria-label="المدينة"
